...
public class NLNoticeDao extends SimpleJdbcDaoSupport implements NoticeDao {
	...
	public void hitUp(String seq) {
		...
		System.out.println(threadName + "->조회수 커밋");
	...
	public int getHit(String seq)
	{
		...
		sleep(Thread.currentThread().getName(), 1000);
		
		hit =getSimpleJdbcTemplate().queryForInt(sql, seq); 
		System.out.println(hit);
		
		return hit;
	}
	
	public void sleep(String threadName, long duration)
	{
